...
const CustomEmptyShape = (
  <symbol viewBox="0 0 200 200" id="customEmpty">
    <circle cx="100" cy="100" r="50" fill="grey"/>
    <g>
...
//     <rect transform="translate(50) rotate(45)" width="80" height="80" fill="rgb(47, 20, 84)" />
//   </symbol>
// );
...
const SkinnyShape = (
  <symbol
    ...
    id="skinny"
  >
    <rect x="0" y="0" rx="2" ry="2" width="70" height="70" fill="darkgrey" />
  </symbol>
);
